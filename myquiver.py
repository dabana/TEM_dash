...
def create_quiver(x, y, u, v, scale=.1, arrow_scale=.3,
    ...
    data = build_arrows(x, y, u, v, scale, arrow_scale, angle, scaleratio, **kwargs)
...
def update_quiver(layout, x_range, y_range, width, height):
    print("Inside callback function")
    scale_x = (x_range[1] - x_range[0]) / width
    scale_y = (y_range[1] - y_range[0]) / height
    scaleratio = scale_y / scale_x
